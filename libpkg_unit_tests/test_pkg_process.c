/*                     T E S T _ P K G _ P R O C E S S  . C
 * BRL-CAD
 *
...
int test_pkg_process (void ) {
    ...
    /* Currently causes segmentation fault, haven't figured out the solution yet */
    /* tester->pkc_incur = 5;
    result = pkg_process(tester);
